addPackageFunctions = (function () {
  ...
  function step2_addBook() {
    ...
    container.appendChild(
      helperFunctions.createLabelAndField(
        'Scan book ISBN: ',
        searchIsbnField,
        '',
  ...
  function createNoISBNBook() {
    ...
    helperFunctions.createAndAddParagraphElement(
      resultsContainer,
      'Fill out the information below and save book (or resource) <br><br>'
    )

    resultsContainer.appendChild(
      helperFunctions.createLabelAndField('Title', addBookTitleId, '', 'Type title')
    )
    resultsContainer.appendChild(
      helperFunctions.createLabelAndField('Author', addBookAuthorId, '', 'Type author')
    )
  ...
  function editOrCreateBook(text, originalIsbn, originalTitle, originalAuthor, isNew) {
    ...
    resultsContainer.appendChild(
      helperFunctions.createLabelAndField('ISBN', addBookISBNId, originalIsbn, '')
    )
    if (originalIsbn == '') {
    ...
    resultsContainer.appendChild(
      helperFunctions.createLabelAndField('Book title', addBookTitleId, originalTitle, 'Type title')
    )
    resultsContainer.appendChild(
      helperFunctions.createLabelAndField(
        'Book author',
